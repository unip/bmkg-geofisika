<nav class="h-[60px] md:h-[70px] px-4 py-3 fixed w-full top-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md z-10">
    <div class="container h-full mx-auto flex gap-3 items-center">
        ...
        <ul class="hidden md:flex items-center">
            ...
            <li>
                <a href="{{ Auth::user() ? '/layanan' : '/#layanan' }}" class="hover:bg-green-700 hover:text-white dark:hover:text-white dark:text-white rounded-full visited:text-green-900 dark:visited:text-green-600 px-5 py-3 transition duration-200">Layanan</a>
            </li>
            <li>
